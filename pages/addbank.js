    ...
    async handleSubmit(event) {
        ...
        try {
            ...
            if(response.status == 200){
                noty('Bank Account Added successfully','success');
                Router.push('/start');
                this.LoadingBar.complete()
                return
            }
        ...
        return (
            <React.Fragment>
                ...
                <PageHeader 
                    ...
                    breadcrumbUrl="/" 
                    breadcrumbTextTwo="Add Bank Account" 
                />
                ...
                <div className="container">
                    <div className="form-content">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <button type="submit" value="Submit" className={this.state.buttonStyle}>Add Bank Account <FontAwesomeIcon icon={faLongArrowAltRight} /> </button> }
...
export default withAuthSync(AddBank)